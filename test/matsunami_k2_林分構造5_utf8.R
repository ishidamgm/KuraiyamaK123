...
survey_area <- 8012.621 ## fin_area_polygon.shp

ddir<-"" ; #"./1224/"
dir(ddir)

#　　 d : rn=227　張さんと毎木結合したもの
...
###### 樹冠面積　⇒　胸高直径
ca2ba       <- function(ca)0.0044189*ca
ca2ba_broad <- function(ca)0.002090*ca
ca2ba_conif <- function(ca)0.0075718*ca

ca2dbh	　　　 <- function(ca)2*sqrt(0.0044189*ca/pi)*100
...
ba2dbh<-function(ba)100*2*sqrt(ba/pi)
...
#lines(yd_canopy_drone_針広なし,col="red",lty=2)	#### ドローン写真からの推定 yd_canopy_drone_針広なし
#lines(yd_canopy_drone_針広別　,col="red",lty=1)	#### ドローン写真からの推定 yd_canopy_drone_針広別
...
#lines(yd_ttops_針広別,col="blue",lty=1,lwd=2) 	#### ttops (針葉樹・広葉樹分けないで　青線)
...
#       [,1]      [,2]     [,3]
#Min.    0.000000 0.0000000 0.000000
#1st Qu. 0.000000 0.0000000 0.000000
#Median  1.000000 1.0000000 1.000000
#Mean    1.008811 0.8046875 1.272727
#3rd Qu. 1.000000 1.0000000 2.000000
#Max.    5.000000 3.0000000 5.000000
...
#abline(c(0,1),lty=2,col="red",lwd=2)
